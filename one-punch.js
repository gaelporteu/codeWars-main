...
const onePunch = items => typeof items === 'string' && items ? items.split(' ').sort().join(' ').split('').filter( letter => letter !== "e" && letter !== "E" && letter !== "a" && letter !== "A").join('') : 'Broken!' //Don't leave this line!!
